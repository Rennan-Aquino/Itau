...
(id_endereco, logradouro, cidade, estado, cep, pais, id_pessoa,complemento, numero)
values (70, 'Rua das Rosas', 'Campinas', 'São Paulo' ,'14811064' ,'Brasil',1 ,'Casa', 12),

       (71, 'Av. Francisco Matarazzo', 'Água Branca', 'São Paulo','16058520','Brasil',2 ,'Apartamento Bloco C', 42),

       (72, 'Barra da Tijuca', 'Rio de Janeiro', 'Rio de Janeiro','09942210','Brasil',3 ,'Apartamento Ala B', 16),

       (73, 'Alphaville 11', 'Barueri' ,'São Paulo' ,'13563788' ,'Brasil',4,'Condominio', 233),

       (74, 'Av. Alpina', 'Nova Lima', 'Minas Gerais' ,'08141690' ,'Brasil',5 ,'Casa', 112);
